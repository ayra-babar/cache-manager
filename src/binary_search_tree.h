...
* @brief Header file that declares the methods in the binary_search_tree.cpp file
*
...
*
* This function is called recursively to perform a reverse in-order starting from the given node
*
